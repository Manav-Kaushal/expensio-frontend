    ...
    <div className="mb-4">
      ...
      <div className="relative rounded-md shadow-sm">
        <input
          ...
          name={name}
          placeholder={label}
          className={`w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-sky-500 duration-200 ease-in-out ${
            icon?.right && "pr-10 "
          }`}
          {...props}
        />
